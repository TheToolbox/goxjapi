...
public interface TradeInterface {
	 ...
	 * 
	 * The first element of the array is the amount in BTC, the second element
	 * in USD and the third in EUR.
	 * 
	 ...
	 * 
	 * @return a double value with the current price of 1 BTC in the Currency
	 *         cur
	 */
	 ...
	 * 
	 * @param amount
	 *            the amount of BTC to withdraw (min 0.1)
	 * @param dest_address
	 ...
	 * 
	 * @param amount
	 *            the amount of BTC to sell (min 0.1)
	 * @return the transaction id (if success), (???) if failed //TODO
	 */
	 ...
	 * 
	 * @param amount
	 *            the amount of BTC to buy (min 0.1)
	 * @return the transaction id (if success), (???) if failed //TODO
	 */
